...
public class APKFileSignDemo {
    ...
    private PCSClient pcsClient = new PCSClient("192.168.80.72","9178");
    //签名私钥KID
    String kid = "9cd2988abf2a52b5414d5461497550c0";
    //私钥保护口令
    ...
    public void testFileSign_filePath() throws Exception{
        //APK文件路径
        String in = "/Users/momocat/Desktop/test/unsigned.apk";
        //输出文件路径
        String out = "/Users/momocat/Desktop/test/signed.apk";
        //签名
