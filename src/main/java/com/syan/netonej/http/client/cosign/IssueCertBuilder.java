...
public class IssueCertBuilder extends BaseClient<IssueCertBuilder> {
    ...
    public IssueCertBuilder setAppid(String appid) {
        this.appid = appid;
        return this;
    }

    public IssueCertBuilder setTransid(String transid) {
        this.transid = transid;
        return this;
    }

    public IssueCertBuilder setSign(String sign) {
        this.sign = sign;
        return this;
    }

    public IssueCertBuilder setKid(String kid) {
        this.kid = kid;
        return this;
    }

    public IssueCertBuilder setCn(String cn) {
        this.cn = cn;
        return this;
    }

    public IssueCertBuilder setO(String o) {
        this.o = o;
        return this;
    }

    public IssueCertBuilder setOu(String ou) {
        this.ou = ou;
        return this;
    }

    public IssueCertBuilder setC(String c) {
        this.c = c;
        return this;
    }

    public IssueCertBuilder setS(String s) {
        this.s = s;
        return this;
    }

    public IssueCertBuilder setL(String l) {
        this.l = l;
        return this;
    }

    public IssueCertBuilder setE(String e) {
        this.e = e;
        return this;
    }

    public IssueCertBuilder setCsr(String csr) {
        this.csr = csr;
        return this;
    }

    public IssueCertBuilder setCertType(String certType) {
    ...
    protected String buildUrlPath() {
        return CosignAction.COSIGN_ACTION_ISSUE;
    }
}
