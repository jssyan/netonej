 ...
 * @Description:
 */
public class KeypairResponse extends NetoneResponse {
    ...
    public KeypairResponse(NetoneResponse response) throws NetonejException {
        ...
        if(response != null && response.getStatusCode() == 200){
            ...
            if(response.getFormat() == ResponseFormat.TEXT){
                try {
                    ...
                    this.setP(json.getString("P"));
                    setResult(json.getString("kid"));
